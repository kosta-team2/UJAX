...
public class NoticePageController implements Controller {
    ...
    @Override
    public ModelAndView handle(String methodName, HttpServletRequest request, HttpServletResponse response) throws Exception {
        return switch (methodName) {
            case "createNotice" -> create(request, response);
            case "getNotice" -> getList(request, response);
