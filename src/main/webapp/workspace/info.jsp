    ...
    <section class="card">
        ...
        <form id="ws-settingsForm"
            ...
            <section class="block">
                ...
                <!-- 🔄 기존 체크박스 → 라디오 세그먼트 UI로 교체 -->
                <div class="grid-2" style="margin-top:10px">
                    <div class="field">
                        <label>힌트보기 설정 <span class="field-desc">문제 풀이 시 힌트 표시 여부</span></label>
                                    ...
                                    <c:if test="${isLeader and !m.leader}">
                                        <div class="row-actions" style="display:flex; gap:8px;">
                                            ...
                                            <form method="post"
                                                ...
                                                <input type="hidden" name="wsMemberId" value="${m.workspaceMemberId}"/>
